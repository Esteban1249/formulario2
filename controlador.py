...
class EmpleadoController:
    ...
    def procesar_formulario(self, datos):
        ...
        if errores:
            # Si hay errores, se lo comunica a la Vista para que muestre el mensaje
            mensaje_error = "Por favor, corrige los siguientes errores:\n" + "\n".join(errores)
            self.vista.mostrar_mensaje("Error de Validación", mensaje_error)
        else:
            # Si no hay errores, le pide al Modelo que guarde los datos
    ...
    def _validar_datos(self, datos):
        ...
        # Validación de Número de Hijos (debe ser un número)
        ...
        # Podrías añadir validación de formato de correo, fecha, etc., aquí
